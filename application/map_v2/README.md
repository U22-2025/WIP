# 次世代気象情報マップアプリケーション v2

地図上の任意の場所をクリックしてリアルタイム気象情報を取得できる、次世代Webアプリケーションの最新版です。従来版からUIを一新し、災害情報の表示にも対応しました。
