...
wt ^
  ...
  ; split-pane -V cmd /k "cd /d %CURRENT_DIR% && conda activate U22-2025 && python launch_server.py --query --debug" ^
  ; focus-pane -t 0 ^
  ; split-pane -H cmd /k "cd /d %CURRENT_DIR% && conda activate U22-2025 && python launch_server.py --location --debug" ^
  ; focus-pane -t 1 ^
