...
def main():
    ...
    try:
        ...
        # Step 2: 災害情報の取得・統合
        json_result = processor.get_disaster_info(url_list, 'python/logs/json/disaster_data.json')
        ...
        with open('python/logs/json/disaster_data.json', 'w', encoding='utf-8') as f:
