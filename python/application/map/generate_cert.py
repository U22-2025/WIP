...
def generate_self_signed_cert():
    ...
    try:
        ...
        cmd = [
            ...
            "-nodes",
            "-subj",
            "/C=JP/ST=Tokyo/L=Tokyo/O=WIP/OU=Development/CN=localhost",
        ]
        ...
        print(
            "2. または、Win32/Win64 OpenSSL https://slproweb.com/products/Win32OpenSSL.html"
        )
...
if __name__ == "__main__":
    ...
    if cert_file and key_file:
        ...
        print(
            "開発用途では「詳細設定」→「localhost にアクセスする（安全ではありません）」"
        )
