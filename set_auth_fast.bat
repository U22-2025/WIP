...
chcp 65001 >nul
echo =====================================
echo WIP Server Fast Authentication Setting Tool
echo =====================================
echo.
...
cls
echo =====================================
echo WIP Server Fast Authentication Settings
echo =====================================
echo.
echo 現在の設定:
echo.
findstr /R "^WEATHER_SERVER_AUTH_ENABLED= ^LOCATION_SERVER_AUTH_ENABLED= ^QUERY_SERVER_AUTH_ENABLED= ^REPORT_SERVER_AUTH_ENABLED= ^WEATHER_SERVER_REQUEST_AUTH_ENABLED= ^LOCATION_RESOLVER_REQUEST_AUTH_ENABLED= ^QUERY_GENERATOR_REQUEST_AUTH_ENABLED= ^REPORT_SERVER_REQUEST_AUTH_ENABLED=" .env
echo.
echo 個別設定メニュー:
echo.
...
echo.
echo 全ての認証を有効化しています...
call :replaceInFile "WEATHER_SERVER_AUTH_ENABLED" "true"
call :replaceInFile "LOCATION_SERVER_AUTH_ENABLED" "true"
call :replaceInFile "QUERY_SERVER_AUTH_ENABLED" "true"
call :replaceInFile "REPORT_SERVER_AUTH_ENABLED" "true"
call :replaceInFile "WEATHER_SERVER_REQUEST_AUTH_ENABLED" "true"
call :replaceInFile "LOCATION_RESOLVER_REQUEST_AUTH_ENABLED" "true"
call :replaceInFile "QUERY_GENERATOR_REQUEST_AUTH_ENABLED" "true"
call :replaceInFile "REPORT_SERVER_REQUEST_AUTH_ENABLED" "true"
echo 全ての認証が有効化されました。
echo.
pause
goto :menu
...
echo.
echo 全ての認証を無効化しています...
call :replaceInFile "WEATHER_SERVER_AUTH_ENABLED" "false"
call :replaceInFile "LOCATION_SERVER_AUTH_ENABLED" "false"
call :replaceInFile "QUERY_SERVER_AUTH_ENABLED" "false"
call :replaceInFile "REPORT_SERVER_AUTH_ENABLED" "false"
call :replaceInFile "WEATHER_SERVER_REQUEST_AUTH_ENABLED" "false"
call :replaceInFile "LOCATION_RESOLVER_REQUEST_AUTH_ENABLED" "false"
call :replaceInFile "QUERY_GENERATOR_REQUEST_AUTH_ENABLED" "false"
call :replaceInFile "REPORT_SERVER_REQUEST_AUTH_ENABLED" "false"
echo 全ての認証が無効化されました。
echo.
pause
goto :menu
...
call :replaceInFile "%varName%" "!varValue!"
echo 設定が完了しました。
echo.
pause
ENDLOCAL
...
> .env.tmp (
    for /f "usebackq delims=" %%a in (".env") do (
        ...
        if "!line:~0,1!"=="#" (
            ...
            echo !line! | findstr /R "^%varName%=" >nul
            if !errorlevel! equ 0 (
